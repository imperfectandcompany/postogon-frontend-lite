      <header x-data="{ open: false }" :class="{'headeropen': open}" id="header" class="z-30 text-center justify-center post" style="touch-action: none;">
         <div class="bg-white">
			...
			<div class="flex mr-auto">
			   ...
			   <a href="./"><h1 class="px-6 text-xl font-semibold cursor-pointer">Messages</h1></a>
			   </div>
			   <div class="flex ">
