...
<html lang="en">
    <head>
        <title>Postogon - Contact us</title>
        <meta charset="utf-8">
...
Postogon</a></div>
    ...
    <div class="container ml-auto mx-auto md:mr-24 relative p-12 lg:top-40 max-w-lg">
      <h1 class="font-semibold text-5xl pb-5 text-center md:text-left">Get in touch</h1>
<form>
  <div class="mb-4">
  ...
  <div class="mb-4">
    <label class="block text-md font-light mb-2" for="password">Message</label>
    <input class="w-full bg-drabya-gray border-gray-500 appearance-none border p-4 font-light leading-tight focus:outline-none focus:shadow-outline" type="message" name="password" id="" placeholder="Message">
  </div>
